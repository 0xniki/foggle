...
class Wrapper:
    ...
    def updatePortfolio(
        ...
        self._logger.debug(f"updatePortfolio: {portfItem}")
        ...
        * handle openOrders and allOpenOrders responses.
        ...
        if order.whatIf:
            ...
            if trade:
                ...
                self._logger.debug(f"openOrder: {trade}")
    ...
    def orderStatus(
        ...
        if trade:
            ...
            if msg is not None:
                ...
                self._logger.debug(f"orderStatus: {trade}")
    ...
    def execDetails(self, reqId: int, contract: Contract, execution: Execution):
        ...
        reqExecutions.
        """
        self._logger.debug(f"execDetails {execution}")
        ...
        if execId not in self.fills:
            ...
            if trade:
                ...
                trade.log.append(logEntry)
                if isLive:
                    self._logger.debug(f"execDetails: {fill}")
    ...
    def commissionReport(self, commissionReport: CommissionReport):
        ...
        if fill:
            ...
            self._logger.debug(f"commissionReport: {report}")
